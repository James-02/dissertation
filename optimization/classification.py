...
def objective(trial, params, idx = 0, **kwargs):
    ...
    reservoir = OscillatorReservoir(units=trial.suggest_float("nodes", 0, 300),
    ...
    filename = f"results/runs/{kwargs['study_name']}-{trial.number}-{idx}-{kwargs['binary']}"
...
if __name__ == "__main__":
    ...
    study = research(study, args.trials, args.processes, **params)

    # evaluate study results
    evaluate_study(study, objective_str="F1 Score")
